...
const layoutClasses: Record<CgiProject["layout"], string> = {
  cinematic: "mx-auto w-full xl:w-[92vw]",
  offset: "ml-auto w-full xl:w-[76vw]",
  standard: "mx-auto w-full xl:w-[74vw]",
  wide: "mx-auto w-full xl:w-[94vw]",
};

const frameClasses: Record<CgiProject["layout"], string> = {
  cinematic: "aspect-[16/10] md:aspect-[21/9]",
  offset: "aspect-[3/2]",
    ...
    >
      <header className="mb-5 grid gap-2 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-end">
        <div>
          ...
          <h2 className="preview-title font-panel-cgi mt-4 font-light uppercase tracking-normal text-text-primary">
            {project.title}
          </h2>
        </div>
