...
export function CgiProjectPreview({ project }: CgiProjectPreviewProps) {
  return (
    ...
    >
      ...
      <div
        className={`relative w-full overflow-hidden bg-[#0a0a0f] sm:min-h-[18rem] ${frameClasses[project.layout]}`}
      >
        <div className="absolute inset-[clamp(0.75rem,2vw,1.75rem)] bg-[#111117]" />
        <div className="absolute inset-[clamp(0.75rem,2vw,1.75rem)] bg-[radial-gradient(circle_at_52%_38%,rgba(244,245,247,0.14),transparent_18rem),linear-gradient(120deg,rgba(125,103,230,0.14),transparent_26%),linear-gradient(180deg,rgba(244,245,247,0.04),rgba(5,5,7,0.74))] transition-transform duration-500 group-hover:scale-[1.01]" />
        <div className="absolute left-[14%] right-[14%] top-1/2 h-px bg-[#f4f5f7]/12" />
        <div className="absolute bottom-[18%] left-1/2 h-[42%] w-px bg-[#f4f5f7]/12" />
        <div className="absolute left-1/2 top-1/2 h-[42%] w-[58%] -translate-x-1/2 -translate-y-1/2 border border-[#f4f5f7]/10 bg-[#050507]/20" />
