...
const rolodexEntries: RolodexEntry[] = [
  {
    ...
    title: "About",
    description:
      "AK. Automotive stills, CG artist and designer. Selected automotive visual work, design and experimentation.",
    href: "/about",
    cta: "Explore profile",
  ...
  },
  {
    index: "02",
    title: "Stills",
    description: "Automotive, motorsport and editorial stills.",
    href: "/photography",
    cta: "Explore stills",
...
function getSlotStyle(slot: number) {
  ...
  return {
    ...
    "--type-photo-tracking": `${interpolate(0.005, -0.018, typeProgress)}em`,
    "--type-cgi-scale-x": interpolate(0.92, 1, typeProgress),
    "--type-cgi-scale-y": interpolate(0.96, 1, typeProgress),
    "--type-cgi-tracking": `${interpolate(0.02, 0.005, typeProgress)}em`,
    "--type-design-scale-x": interpolate(0.9, 1.01, typeProgress),
    "--type-design-scale-y": interpolate(0.94, 1, typeProgress),
    "--type-design-tracking": `${interpolate(0.012, -0.004, typeProgress)}em`,
  } as CSSProperties;
}
